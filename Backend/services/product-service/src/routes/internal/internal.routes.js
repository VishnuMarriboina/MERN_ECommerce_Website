...
const { getStock, getProduct, decrementStock, restoreStock, incrementPurchaseCount } = require("../../controllers/internal/internal.controller");
...
router.put("/stock/restore", restoreStock);
